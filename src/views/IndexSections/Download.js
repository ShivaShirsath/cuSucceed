              ...
              <Col className="text-center" lg="8">
                ...
                <div className="text-center">
                  ...
                  <Row className="justify-content-center">
                    <Col lg="2" xs="4">
                      <a
                        href="https://ShivaShirsath.github.io/cuSucceed/product/SS-design-system?ref=adsr-landing-page"
                        id="tooltip255035741"
                        target="_blank"
                      >
                        <img
                    ...
                    <Col lg="2" xs="4">
                      <a
                        href="https://ShivaShirsath.github.io/cuSucceed/product/vue-SS-design-system?ref=adsr-landing-page"
                        id="tooltip265846671"
                        target="_blank"
                      >
                        <img
                    ...
                    <Col lg="2" xs="4">
                      <a
                        href="https://ShivaShirsath.github.io/cuSucceed/product/SS-design-system-angular?ref=adsr-landing-page"
                        id="tooltip233150499"
                        target="_blank"
                      >
                        <img
